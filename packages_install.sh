...
$cmd aptitude vim openssh-server screen byobu unrar nethogs mc bzip2 zip gzip unzip p7zip-full iptraf sysstat nmap sysv-rc-conf sl pwgen traceroute pastebinit iotop htop whowatch byobu vbindiff
